...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="u" tolerance="1e-6">0.344377</value>
            <value variable="v" tolerance="1e-6">0.0263817</value>
            <value variable="p" tolerance="1e-6">0.339434</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-6">0.322039</value>
            <value variable="v" tolerance="1e-6">0.0272514</value>
            <value variable="p" tolerance="1e-6">0.491024</value>
        </metric>
    </metrics>
</test>
