...
<test>
    ...
    <metrics>
        <metric type="L2" id="1">
            <value variable="u" tolerance="1e-6">0.00111638</value>
            <value variable="v" tolerance="1e-6">0.000229595</value>
            <value variable="w" tolerance="1e-6">0.000213419</value>
            <value variable="p" tolerance="1e-6">0.00129445</value>
        </metric>
        <metric type="Linf" id="2">
            <value variable="u" tolerance="1e-6">0.00900795</value>
            <value variable="v" tolerance="1e-6">0.0014178</value>
            <value variable="w" tolerance="1e-6">0.00105613</value>
            <value variable="p" tolerance="1e-6">0.0080662</value>
        </metric>
    </metrics>
</test>
